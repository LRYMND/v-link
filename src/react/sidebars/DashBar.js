        ...
        <div className={`dashbar ${userSettings.app.colorTheme.value}`}>
            <div className="dashbar__dash">
                <div className="dashbar__dash__bar">
                    <h5>{canbusSettings.messages[userSettings.dash_bar.value_1.value].label}: {carData[userSettings.dash_1.value_1.value]}{canbusSettings.messages[userSettings.dash_bar.value_1.value].unit}</h5>
                </div>

                <div className="dashbar__dash__bar">
                    <h5>{canbusSettings.messages[userSettings.dash_bar.value_2.value].label}: {carData[userSettings.dash_1.value_1.value]}{canbusSettings.messages[userSettings.dash_bar.value_2.value].unit}</h5>
                </div>

                <div className="dashbar__dash__bar">
                    <h5>{canbusSettings.messages[userSettings.dash_bar.value_3.value].label}: {carData[userSettings.dash_1.value_1.value]}{canbusSettings.messages[userSettings.dash_bar.value_3.value].unit}</h5>
                </div>
            </div>
